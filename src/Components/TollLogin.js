...
export default function Start({setSelectedToll,setSignInButton}) {
    ...
    <div className='container'>
      ...
      <div className='row mt-4'>
        <form className="col-12 col-md-6">
          ...
          <br />
          <div className='mt-2'>
            <input type="password" id="pwd" className="btn btn-secondary opacity-100" placeholder="Enter your password" required value={pwd} style={{color:'black',background:'white'}} onChange={handlePwdChange} />
          </div>
          <br></br>
