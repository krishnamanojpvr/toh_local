...
export default function Navbar({ signInButton, setCookie }) {
  ...
  return (
    <nav className="container navbar navbar-expand-lg  border border-3 border-white rounded-5 w-75 mt-3 border-body fixed-top " style={{ background: 'black' }} data-bs-theme="dark">
