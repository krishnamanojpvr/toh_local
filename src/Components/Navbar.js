...
export default function Navbar({ signInButton ,setCookie}) {
  ...
  return (
    <nav className="container navbar navbar-expand-lg border bg-black 5u border-2 border-white rounded-5 w-75 mt-3  border-body " style={{ background: '#333333' }} data-bs-theme="dark">
          ...
          {modal && (
            <div>
              <div className="modal show" style={{ display: 'flex', width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center' }} data-bs-dismiss='modal'>
                <div className="modal-dialog border border-white border-lg border-3" style={{ width: '100%', margin: 'auto' }}>
                  <div className="modal-content" ref={modalRef}>
                    ...
                    <div className="modal-body bg-black " style={{ color: 'white' }}>
                      Are you sure ?
                    </div>
