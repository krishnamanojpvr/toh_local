            ...
            <div className="Guest container shadow-lg rounded-3 m-0 w-50" style={{backgdropFilter:'blur(10px)'}}>
                <div className="row">
                    <div className="col-sm-12 mt-4 text-center ">
                        <Link to="/guest/upload" type="button" className="btn btn-dark bg-black Guestbt">Upload Your Tire Image Here</Link>
                    </div>
                    <div className="col-sm-12 mt-4 text-center">
                        <Link to="/guest/checkdetails" type="button" className="btn btn-dark bg-black Guestbt" >Check Your Vehicle Details</Link>
                    </div>
