...
export default function GuestDetails() {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log("Output : Status : ", response.data[0].tyreStatus[0].class);
        console.log("Output : Confidence : ", response.data[0].tyreStatus[0].confidence);
        setStatus(response.data[0].tyreStatus[0].class);
        setConfidence(response.data[0].tyreStatus[0].confidence);
